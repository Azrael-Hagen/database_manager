...
class LineaTelefonica(Base):
    ...
    categoria_linea = Column(String(20), default="NO_DEFINIDA", nullable=False, index=True)
    estado_conexion = Column(String(20), default="DESCONOCIDA", nullable=False, index=True)
